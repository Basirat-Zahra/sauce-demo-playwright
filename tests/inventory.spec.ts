...
test.describe('Inventory / Product Listing', () => {
  ...
  test('displays all 6 products with name, price, description and image', async () => {
  ...
  test('add to cart button toggles to Remove and badge updates', async () => {
  ...
  test('adding multiple items increments badge count correctly', async () => {
  ...
  test('removing item from inventory page decrements badge and reverts button', async () => {
  ...
  test('no badge is shown when cart is empty', async () => {
